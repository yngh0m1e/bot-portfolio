...
class DB_Manager:
    ...
    def insert_or_update_project(self, user_id, project_name, description, url, status_id):
        ...
        if project_id:
            ...
            self.insert_project([(user_id, project_name, description, url, status_id)])
...
if __name__ == '__main__':
    ...
    manager.insert_or_update_project(user_id, project_name, description, url, status_id)
